...
public class BachTuoc : Mob, IMapObject
{
	...
	public override void paint(mGraphics g)
	{
		...
		data.paintFrame(g, frame, x, base.y + fy, (dir != 1) ? 1 : 0, 2);
		g.translate(0, -GameCanvas.transY);
		...
		g.drawRegion(imgHPtem, 0, 0, num, imageHeight, 0, num3, y, mGraphics.TOP | mGraphics.LEFT);
		g.drawRegion(imgHPtem, 0, 0, num2, imageHeight, 0, num3 + imageWidth, y, mGraphics.TOP | mGraphics.LEFT);
		if (shock)
		{
			tShock++;
			Effect me = new Effect((type != 2) ? 22 : 19, x + tShock * 50, base.y + 25, 2, 1, -1);
			EffecMn.addEff(me);
			Effect me2 = new Effect((type != 2) ? 22 : 19, x - tShock * 50, base.y + 25, 2, 1, -1);
			EffecMn.addEff(me2);
			if (tShock == 50)
			{
				tShock = 0;
